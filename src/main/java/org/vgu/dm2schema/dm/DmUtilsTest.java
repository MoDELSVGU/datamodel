...
public class DmUtilsTest {
    ...
    public static void main(String[] args) throws Exception {
        ...
        // // test DmUtils
        // // getAssociationName();
        // String assocName = DmUtils.getAssociationName(dataModel, "University", "programs");
        // System.out.println(assocName);

        // // getAssociationOppClassName();
        // String assocOppClassName =
        //         DmUtils.getAssociationEndTargetClassName(dataModel, "University", "programs");
        // System.out.println(assocOppClassName);

        // // getAssociationOppClassName();
        // String oppAssocName =
        //         DmUtils.getAssociationEndSourceClassName(dataModel, "University", "programs");
        // System.out.println(oppAssocName);

        // System.out.print("getAssociationOppClassName() --> ");
        // boolean isEndOfClass =
        //         DmUtils.isAssociationEndOfClass(dataModel, "Program", "module_periods");
