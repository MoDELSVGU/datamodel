...
CREATE TABLE Program (Program_id INT (11) NOT NULL AUTO_INCREMENT PRIMARY KEY, name VARCHAR (100) , code VARCHAR (100) UNIQUE NOT NULL);
...
CREATE TABLE Student (Student_id INT (11) NOT NULL AUTO_INCREMENT PRIMARY KEY, code VARCHAR (100) NOT NULL UNIQUE, birthplace VARCHAR (100) NOT NULL, dob DATE NOT NULL, midname VARCHAR (100) , gender VARCHAR (100) NOT NULL, firstname VARCHAR (100) NOT NULL, lastname VARCHAR (100) NOT NULL);
CREATE TABLE Module (Module_id INT (11) NOT NULL AUTO_INCREMENT PRIMARY KEY, name VARCHAR (100) , code VARCHAR (100) NOT NULL UNIQUE);
...
CREATE TABLE Exam (Exam_id INT (11) NOT NULL AUTO_INCREMENT PRIMARY KEY, starts TIME , date DATE NOT NULL, ends TIME , deadline DATETIME );
