...
USE unipof;
CREATE TABLE Module_Period (Module_Period_id INT (11) NOT NULL AUTO_INCREMENT PRIMARY KEY, name VARCHAR (100) NOT NULL UNIQUE, starts DATE NOT NULL, ends DATE NOT NULL);
CREATE TABLE Program (Program_id INT (11) NOT NULL AUTO_INCREMENT PRIMARY KEY, code VARCHAR (100) NOT NULL UNIQUE, doe DATE , name VARCHAR (100) );
CREATE TABLE Registration_Exam (Registration_Exam_id INT (11) NOT NULL AUTO_INCREMENT PRIMARY KEY, time TIME , date DATE , status INT (1) );
...
CREATE TABLE Module (Module_id INT (11) NOT NULL AUTO_INCREMENT PRIMARY KEY, code VARCHAR (100) UNIQUE NOT NULL, name VARCHAR (100) );
CREATE TABLE Exam (Exam_id INT (11) NOT NULL AUTO_INCREMENT PRIMARY KEY, ends TIME NOT NULL, deadline DATETIME NOT NULL, date DATE NOT NULL, starts TIME NOT NULL);
